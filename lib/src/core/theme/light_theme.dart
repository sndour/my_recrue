...
final lightTheme = FlexThemeData.light(
  ...
  subThemesData: FlexSubThemesData(
    ...
    bottomNavigationBarUnselectedIconSchemeColor: SchemeColor.black,
    bottomNavigationBarSelectedLabelSchemeColor: SchemeColor.primary,
    bottomNavigationBarUnselectedLabelSchemeColor: SchemeColor.black,
    bottomNavigationBarType: BottomNavigationBarType.shifting,
    bottomNavigationBarBackgroundSchemeColor: SchemeColor.secondary,
  ),
  keyColors: const FlexKeyColors(useKeyColors: false, useSecondary: false),
